 ...
 <div className="album py-5">
        ...
        <div className="container">
            ...
            <div className="col-md-30">
                        ...
                        <br/>
                                <h6 className="card-text"> Welcome to the portal www.unaionefamily.com, The Application is operated by Uniaione Save Family Services Private Limited. Registered under India Act 2013 Govt.of India(CIN No. U85300WB2020PTC238719)
                                 </h6>
                                ...
                                <p className="card-text">Uniaone Family  is set up to leverage the power of digital technology to empower healthcare providers and consumers in India.  </p>
                                ...
                                <p className="card-text"> I. Uniaone Family reserves its rights to modify, update, change, edit, alter, amend, revise or substitute (collectively “Revisions”) the Agreement from time to time. Any Revisions made will be effective immediately upon their posting on the Digital Platform.</p>
...
v. Website means www.uniaonefamily.com</p>
...
ii. Book an appointment for consultation with Healthcare Professionals.<br/>
iii. Video Consultation with Healthcare Professionals for  medical care.<br/>
iv. Book an appointment for Diagnostic Services (Pathology Laboratory Services, NABL & CAP CERTIFIED)<br/>
v. Health and Nutritional information (Health Content Services)<br/>
vi. Health Fitness Services<br/>
vii. Medication Reminders<br/>
viii. Rewards Program</p>
<p className="card-text"><b>7. Return/ Refund Policy</b></p>
<p className="card-text">i. For Book Appointment Services <br/>
ii. For Diagnostic Test</p>
<p className="card-text"><b> 8. Terms of return/refund </b></p>
<p className="card-text">i. Payment will be refunded within 72 hours if the doctor is not shown for any reason after booking the doctor.<br/>

ii. Payment will be refunded within 72 hours if blood is not taken within 3 days for any reason after booking the diagnostic test.
