...
function App() {
  return (
    ...
    itwork="How it works" works1="Select a speciality or symptom" works2="Audio / video call with a verified doctor" works3="Get a digital prescription & a free follow-up" userhap="Happy Users" verifieddoc="Verified Doctors" ratings="Doctor Rating"   rupeesb3="199" user="2MILLIONS+" userb="1.5MILLION+" userc="20+" userd="4.5/5"/>}/>
